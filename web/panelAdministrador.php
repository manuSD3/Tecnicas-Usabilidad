...
<body>
    <header class="header">
       ...
       <div>
                <button class="botones-header"><a href="panelAdministrador.php"> Mis datos </a></button>
       </div>
    </header>
    <!--=============FORMULARIO===========================-->

    <form id="formulario" name="registro" action="cerrarSesion.php" method="post" onsubmit="return validarTodo();">
    <h1>Panel de control del administrador: <br> <?php  echo $user['nombre'];?></h1>
        ...
        <br>
        <br>
        <button type="button" onclick="alert('En construcción')">Gestionar hosting</button>
        <button type="button" onclick="alert('En construcción')">Instalar plugins</button>
        <button type="button" onclick="alert('En construcción')">Configuración</button>
        <button type="button" onclick="alert('En construcción')">Copias de seguridad</button>
        <button type="button" onclick="alert('En construcción')">Gestionar usuarios</button>
        <br>
        <br>      
        <br>
